...
const routes: Routes = [
  {
    path: "",
    loadChildren: () =>
      import("./components/user-support-login/ehr-user-support-login.module").then(
        m => m.EhrUserSupportLoginModule
      ),
    pathMatch: "full"
  },
  {
    path: "home",
    loadChildren: () =>
      import("./components/user-dashboard/ehr-user-dashboard.module").then(
        m => m.EhrUserDashboardModule
      )
  }
];
